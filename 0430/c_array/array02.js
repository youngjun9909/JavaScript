...
//? 배열 스프레드 연산자
// : ES6에 도입된 기능
// : 배열 또는 객체의 요소를 개별 요소로 확장하거나 여러 요소를 하나의 배열로 결합할 때 사용
// : ... 형태로 사용
...
originalArray[1] = 5; // 원본 배열 수정
console.log(copiedArray); // [ 1, 2, 3 ] - copiedArray는 영향받지 X

let array1 = [11, 22, 33];
let array2 = array1;

array1[1] = 55;
console.log(array2); // [ 11, 55, 33 ] - 스프레드 연산자와 달리 원본 배열 수정
...
let mergedArray = [...number1, ...number2];
let mergedReverse = [...number2, ...number1];
...
let result = fruits.join(); // 구분자 사용 X: 문자열이 쉼표로 구분
let resultWithSpace = fruits.join(' '); // 구분자 사용 X: 문자열이 쉼표로 구분
let resultWithDash = fruits.join('-'); // 구분자 사용 X: 문자열이 쉼표로 구분
